...
$safeModePassword = "InsertPassword!0"
## Supplies the password for the administrator account when the computer is started in
## Safe Mode or a variant of Safe Mode, such as Directory Services Restore Mode. You must
## supply a password that meets the password complexity rules of the domain and the
